...
import ca.jrvs.apps.trading.service.TraderAccountView;
...
public class TraderAccountController {
    ...
    @ApiOperation(value="Create a trader and an account.", notes = "TraderID and AccountID are auto generated by database and should be identical. Assume each trader has exactly one account")
    @ResponseBody
    ...
    @ApiOperation(value="Create a trader and an account with DTO", notes="TraderId and AccountID are auto generated by the database, and they should identical.")
    ...
    @ApiOperation(value="Delete a trader",notes="Delete a trader if its account amount is 0 and no open positions. Also delete the associated account and security orders.")
    ...
    @ApiOperation(value="Deposit a fund",notes="Deposit a fund to the account that associates with the given TickerID.")
    @ApiResponses(value={@ApiResponse(code=404,message="traderId is not found"), @ApiResponse(code=400, message="Unable to deposit due to user input")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
